...
struct
  fun main () =
    let
      ...
      val allowSuccessorML =
        CommandLineArgs.parseBool "allow-successor-ml" false
      val allowOptBar =
        CommandLineArgs.parseBool "allow-opt-bar" allowSuccessorML
      val allowRecordPun =
        CommandLineArgs.parseBool "allow-record-pun-exps" allowSuccessorML
      val allowOrPat =
        CommandLineArgs.parseBool "allow-or-pats" allowSuccessorML
      ...
      val _ =
        if
          List.null inputfiles
          andalso (doForce orelse preview orelse previewOnly)
        then
          failWithMessage
        ...
        let
          ...
          fun checkIfFormatted () =
            ...
            in
              case isFormatted of
                EQUAL =>
                  (TCS.print (boldc Palette.green "PASS "); print (hfp ^ "\n"))
